...
##### Login:
  ...
  2. Validación de credenciales en PHP.
...
##### Cambio de contraseña (cambiar_password.php):
  ...
  2. Verificar la contraseña actual usando password_verify.
  3. Guardar la nueva contraseña con password_hash.
...
##### Seguridad mínima esperada:
  1. Uso de password_hash y password_verify.
...
2. Cómo se maneja la sesión PHP (ejemplo con $_SESSION).
3. Qué medidas de seguridad se aplicaron (hash de contraseña, validaciones, verificación de sesión).
#### Repositorio:
